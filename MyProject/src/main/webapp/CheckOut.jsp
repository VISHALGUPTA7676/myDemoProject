...
<div class="container" style="margin-top:100px">
        <div class="card  mt-5 ">
                        ...
                        <div class="card-body ">
                            <table class="table table-striped bg-light " >
                                <tr><% HttpSession sessi=request.getSession(); %>
                                    <th>Total Payable Amount :</th><td class="text-right"><%=sessi.getAttribute("taotalpay")%></td>
                                </tr>
                                <tr>
            ...
            <div class="card-footer border">
               <table class="table">
                <tr>
                    <th>Total Price   :</th><td class="text-right"><%=sessi.getAttribute("taotalpay") %></td>
            ...
            <div class="forms " id="hideMe" style="display:none">
                <form action="" >
                     ...
                     <div class="mx-auto mt-3" style="width: 200px;">
                        <button class="btn btn-outline-primary" name="action" value="finalpayout" style="width:auto;border-radius:8px">Submit</button>
                      </div>
          			</form>
            </div>
